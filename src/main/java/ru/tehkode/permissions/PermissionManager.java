...
public class PermissionManager {
    ...
    /**
     * Update a user in cache. This method is thread-safe and should only be
     * called in async phases of login.
     *
    ...
    /**
     * Creates a backend but does not set it as the active backend. Useful for
     * data transfer &amp; such
     *
